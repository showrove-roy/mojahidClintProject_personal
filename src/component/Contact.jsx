...
export default function Contact() {
  return (
    ...
    <section id='contact' className='pb-16 m-auto'>
      <h2 className="text-headingColor font-[700] text-[2.5rem] my-12 text-white">Contact</h2>
      <div className='container'>
        <div className='md:flex justify-between items-center '>
          <div data-aos='fade-down-right' data-aos-duration='1200' className='w-full md:w-1/2 h-[300px]  sm:h-[450px] m-auto'>
          ...
          <div data-aos='fade-down-left' data-aos-duration='1200' className='w-full mt-8  md:mt-0 md:w-1/2 sm:h-[450px] lg:flex items-center  px-4 lg:px-8 py-8'>
            <form action="" className='w-full  '>
              ...
              <button className='w-full p-3 foucs:outline-none rounded-[5px] bg-smallTextColor text-white bg-cyan-600 text-center ease-in duration-150'> Send Message </button>
            </form>
