...
function App() {
  ...
  return (
    ...
    <div name='home' className='h-[780px] w-full m-auto  py-16    relative group z-10 px-2'>
      <div
        style={{ backgroundImage: `url(${slides[currentIndex].url})` }}
        className='w-full h-full rounded bg-center object-cover bg-cover duration-500 relative mt-7'
      >
